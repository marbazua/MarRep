...
1. How many variables (columns) are in the `iris` dataset, and what are their names? 5 Sepal.Length
<dbl>
Sepal.Width
<dbl>
Petal.Length
...
#3.-
filter(gapminder, country=="Canada" | (country=='Algeria' &  year %in% c(1960:1969)))
...
__Exercise__: Make a new column called `cc` that pastes the country name followed by the continent, separated by a comma. (Hint: use the `paste` function with the 
sep=", "` argument).
```{r}
